public class sortingAlgorithms {
     ...
     */
    public List quickSorted(List list,Nodo current) {
        Nodo Compare = list.getFirst();
     ...
     * @return
     */
    private List nuevaLista(List list, List right, List left, Nodo current) {
        list.delteList();
        Nodo currentLeft = left.getFirst();
        Nodo currentRight = right.getFirst();
    ...
    public List bubleSort(List list) {//Se le envia una lista
        if (list.getFirst() == null) {//Rebisa que el primero no sea null
            ...
            Nodo current = list.getFirst();//Guarda el primer nodo de la lisya
    ...
    private List newList(List list, List arrayList) {
        list.delteList();
        Nodo currentlList = arrayList.getFirst();
        List listAux = (List) currentlList.getDato();
        Nodo nodoInList = listAux.getFirst();
